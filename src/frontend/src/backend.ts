...
import type { BlogPost as _BlogPost, CreateBlogResult as _CreateBlogResult, ProfileImage as _ProfileImage, SubmitResult as _SubmitResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async createBlog(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: string): Promise<CreateBlogResult> {
        if (this.processError) {
            try {
                const result = await this.actor.createBlog(arg0, arg1, arg2, arg3, arg4, arg5);
                return from_candid_CreateBlogResult_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
    ...
    async deleteBlog(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getProfileImage(): Promise<ProfileImage | null> {
        if (this.processError) {
            try {
    ...
    async setProfileImage(arg0: string, arg1: string): Promise<ProfileImage> {
        if (this.processError) {
            try {
                const result = await this.actor.setProfileImage(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContact(arg0: string, arg1: string, arg2: string): Promise<SubmitResult> {
        if (this.processError) {
            try {
                ...
                return from_candid_SubmitResult_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_CreateBlogResult_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CreateBlogResult): CreateBlogResult {
    return from_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function from_candid_SubmitResult_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmitResult): SubmitResult {
...
function from_candid_opt_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProfileImage]): ProfileImage | null {
    return value.length === 0 ? null : value[0];
}
