import { r as reactExports, j as jsxRuntimeExports } from "./index-BPyCoULN.js";
const SKILL_GROUPS = [
  {
    category: "Automation",
...
function SkillBar({ skill, animate, delay }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: skill.name }) }),
